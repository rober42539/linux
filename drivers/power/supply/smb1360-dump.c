...
static const struct smb1360_regset smb1360_shdn_trim = {
	.name	= "shutdown/trim",
	.start	= 0x1A,
	.end	= 0x1C,
	.regs	= {
...
static const struct smb1360_regset smb1360_fg_gain = {
	.name	= "fg gain",
	.start	= 0x1D,
	.end	= 0x1E,
	.regs	= {
...
void smb1360_dump(struct i2c_client *client)
{
	...
	smb1360_regset_dump(client, &smb1360_shdn_trim);
...
{
	smb1360_regset_dump(fg_client, &smb1360_fg_gain);
